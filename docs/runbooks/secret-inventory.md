...
|---|---|---|---|
| `SHOPIFY_API_SECRET` | Development, Production | Cloudflare Workers | da configurare per ambiente |
| `SESSION_ENCRYPTION_KEY` | Development, Production | Cloudflare Workers | da generare separatamente per ambiente |
