...
| `TELEGRAM_WEBHOOK_SECRET` | Production | Cloudflare Workers | configurato il 9 settembre 2026 con un valore casuale ammesso da Telegram e conservato fuori dal repository |
