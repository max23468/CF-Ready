...
| **Riconferma schema sul candidato `1.0.0`** | fonti ufficiali rilette il 26 agosto; `npm run verify:function-schema` è parte di `npm run check` ed è riuscito in locale e nella CI dell'HEAD remoto; il deploy Development `345c27d` ha verificato typegen, 109 fixture e build Function | ✅ M11 |
