...
| **Riconferma schema sul candidato `1.0.0`** | fonti ufficiali rilette il 26 agosto; `npm run verify:function-schema` è riuscito in locale ed è ora un gate autenticato esplicito dei workflow Development e Production; il deploy Development `345c27d` ha verificato typegen, 109 fixture e build Function | ⚠️ nuovo run Development richiesto prima della promozione |
