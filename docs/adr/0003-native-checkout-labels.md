...
I contesti di mercato vengono letti da `Market.webPresences`. Un’unica presenza
viene distinta fra assegnata direttamente ed ereditata; zero presenze, più
presenze o paginazione incompleta restano ambigui e richiedono la verifica nel
checkout. Il campo singolo deprecato `Market.webPresence` non è una fonte
ammessa.
...
richiede un confronto aggiornato.
